      ...
      <div className="bg-white rounded-2xl p-8 max-w-md w-full relative">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for your interest. Our medical experts will contact you soon with a personalized treatment plan.
          </p>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full relative">
        ...
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">User already registered</h3>
          <p className="text-gray-600 mb-6">
...
const FormSection: React.FC<FormSectionProps> = ({ title, subtitle, className = "", id }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://backend.yapitahealth.com/api/v1/patients/', {
        method: 'POST',
        headers: {
  ...
  return (
    <>
      <div id={id} className={`bg-white p-8 rounded-2xl shadow-xl border border-gray-100 ${className}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <div className="flex space-x-4">
              <label className="flex items-center">
                ...
                />
                <span className="block text-sm font-medium text-gray-700">Mr</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
                  ...
                  className="mr-2 text-fortis-600 focus:ring-fortis-500"
                />
                <span className="block text-sm font-medium text-gray-700">Ms</span>
              </label>
            </div>
          </div>
          ...
          <div>
            <PhoneInput
              ...
              numberInputProps={{
                className: 'w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-fortis-500 focus:border-transparent transition-all pl-16'
              }}
            />
          </div>
